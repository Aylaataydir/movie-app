...
const Login = () => {
  ...
  const { login, signUpWithGoogle, forgotPassword } = useContext(AuthContext);
  ...
  return (
    ...
    <div>
      <div className='border border-base-content/10 max-w-lg mt-4 mx-4 pb-12 rounded-lg sm:mx-auto'>
        <div className="flex min-h-full flex-col justify-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="block w-full rounded-md bg-base-content/5 px-3 py-1.5 text-base text-base-content outline-1 -outline-offset-1 outline-base-content/10 placeholder:text-base-content/40 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
                  />
                </div>
              </div>
            ...
            <button
              onClick={() => signUpWithGoogle(redirectTo)}
          ...
          <p className='text-center mt-5 font-semibold'>
            ...
            <Link href="/register" className="underline ms-2 font-bold">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
